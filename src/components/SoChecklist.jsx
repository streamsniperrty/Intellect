...
function SoChecklist() {
  ...
  let soitems = [
    ...
    "Aim for leadership positions in clubs.",
  ...
  async function fetchData() {
    ...
    if (docSnap.exists()) {
      ...
      const values = Object.values(data.sochecklist);
      console.log(values);
      setBools(values);
    } else {
      await setDoc(docRef, { sochecklist: fObj }, { merge: true });
